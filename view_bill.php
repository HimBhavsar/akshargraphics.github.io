                ...
                <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="view_bill.php">Bill Details</a>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['deleteid'])){
                                                ...
                                                $deletequery = $mysqlicon->query("delete from bill_table where b_id='{$deleteid}'") or die("Error in Query".$mysqlicon->error);
                                            }
                                        ?>
                                        <table class="table">
                                            ...
                                            <?php
                                                $query = $mysqlicon->query("SELECT
                                                            ...
                                                            FROM
                                                                akshar_graphics_db.client_table
                                                                INNER JOIN akshar_graphics_db.bill_table 
                                                                    ON (client_table.c_id = bill_table.c_id)
                                                                INNER JOIN akshar_graphics_db.quotation_table 
                                                                    ON (quotation_table.q_id = bill_table.q_id)
                                                                INNER JOIN akshar_graphics_db.material_table 
                                                                    ON (material_table.mtr_id = bill_table.mtr_id);")
                                                ...
                                                while ($row = $query->fetch_array()) {
                                                    ...
                                                    echo "<td><a href='edit_bill.php?eid={$row['b_id']}'>Edit </a> | <a Onclick='return ConfirmDelete();' href='?deleteid={$row['b_id']}'>Delete</a></td>";
                                                    echo "</tr>";
                                                }                   
                                            ?>
                                        </table>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <nav class="footer-nav">
                                    <ul>
                                        <li>
                                            <a href="./ins_bill.php">Insert Bill Details</a>
                                        </li>
                                    </ul>
                                </nav>
