...
//    $mtg_id = $_POST['mtg_id'];
    ...
    $result1 = mysqli_query($mysqlicon,"select v_name from visitor_table where v_id = '{$v_id}'")
            or die("Error in Query Using Die" . $mysqlicon->error);
    $row1 = mysqli_fetch_array($result1);
    $c_name = $row1['v_name'];
    $result2 = mysqli_query($mysqlicon,"select v_mob from visitor_table where v_id = '{$v_id}'")
            or die("Error in Query Using Die" . $mysqlicon->error);
    $row2 = mysqli_fetch_array($result2);
    $c_mob = $row2['v_mob'];
    $result3 = mysqli_query($mysqlicon,"select meeting_table.mtg_id from meeting_table,visitor_table where visitor_table.v_id = meeting_table.v_id and meeting_table.v_id = '{$v_id}'")
            or die("Error in Query Using Die" . $mysqlicon->error);
    $row3 = mysqli_fetch_array($result3);
    $mtg_id = $row3['mtg_id'];
    $query = $mysqlicon -> query("insert into client_table (c_name, c_mob, mtg_id,v_id) values ('{$c_name}','{$c_mob}','{$mtg_id}','{$v_id}')")
            or die("Error in Query Using Die" . $mysqlicon->error);
    if ($query) {
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
          <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="ins_client.php">Insert Client Details</a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-md-5 px-1">
                            <div class="form-group">
                                ...
                                <input id="form_name" name="mtg_id" type="text" class="form-control" placeholder="Meeting Type">
                            </div>
                        </div> -->
                  </div>
                  <div class="row">
      ...
      <footer class="footer footer-black  footer-white ">
        <div class="container-fluid">
          <div class="row">
              ...
              <ul>
                <li>
                    <a href="./view_client.php">View Client Details</a>
                </li>
