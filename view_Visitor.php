      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
          <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="view_Visitor.php">View Visitor Details</a>
                        </div>
...
if(isset($_GET['deleteid']))
{
    ...
    $deletequery = $mysqlicon->query("delete from visitor_table where v_id='{$deleteid}'") or die("Error in Query".$mysqlicon->error);
...
while ($row = $query->fetch_array()) {
    echo "<tr>";
    echo "<td>{$row['v_id']}</td><td>{$row['v_name']}</td><td>{$row['v_mob']}</td><td>{$row['v_feedback']}</td>";
    echo "<td><a href='edit_requirement.php?eid={$row['v_id']}'>Edit </a>| <a Onclick='return ConfirmDelete();' href='?deleteid={$row['v_id']}'>Delete</a></td>";
    echo "</tr>";
}
?>
        ...
        <div class="container-fluid">
          <div class="row">
            <nav class="footer-nav">
                <ul>
                    <li>
                        <a href="./ins_Requirement.php">Insert Visitors Details</a>
                    </li>
                </ul>
            </nav>
