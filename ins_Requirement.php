...
if ($_POST) {
    ...
    $query = $mysqlicon -> query("insert into visitor_table (v_name, v_mob, v_feedback) values ('{$v_name}','{$v_mob}','{$v_feedback}')")
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
          <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="ins_Requirement.php">Insert Requirement</a>
                        </div>
          ...
          <div class="col-md-12">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Requirement Form</h5>
              </div>
              <div class="card-body">
                  <form method="post">
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input id="form_name" name="v_name" type="text" class="form-control" placeholder="Client Name">
                      </div>
                    </div>
                    <div class="col-md-5 px-1">
                      <div class="form-group">
                        <label>Mobile Number</label>
                        <input id="form_name" name="v_mob" type="text" class="form-control" placeholder="Mobile Number">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-11 pr-1 px-1">
                        <div class="form-group" style="padding-left: 12px;">
                            ...
                            <input id="form_name" name="v_feedback" type="text" class="form-control" placeholder="Requirements" >
                        </div>
                    </div>
                  </div>
                  <div class="row">
