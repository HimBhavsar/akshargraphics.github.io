                ...
                <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="view_materials.php">Materials Details</a>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['deleteid'])){
                                                ...
                                                $deletequery = $mysqlicon->query("delete from material_table where mtr_id='{$deleteid}'") or die("Error in Query".$mysqlicon->error);
                                            }
                                        ?>
                                        <table class="table">
                                            ...
                                            <?php
                                                ...
                                                while ($row = $query->fetch_array()) {
                                                    echo "<tr>";
                                                    echo "<td>{$row['mtr_id']}</td><td>{$row['mtr_type']}</td><td>{$row['mtr_pricePerFeet']}</td><td>{$row['mtr_designCharge']}</td>";
                                                    echo "<td><a href='edit_material.php?eid={$row['mtr_id']}'>Edit </a> | <a Onclick='return ConfirmDelete();' href='?deleteid={$row['mtr_id']}'>Delete</a></td>";
                                                    echo "</tr>";
                                                }                   
                                            ?>
                                        </table>
