...
if ($_POST) {
    ...
    $GST = ($q_subTotal*18)/100;
    $grandTotal = $q_subTotal+$GST;
    $v_id = $_POST['v_id'];
    $mtr_id = $_POST['mtr_id'];
    
    $query = $mysqlicon -> query("insert into quotation_table (q_labourCharge, q_shiftingCharge, q_subTotal, q_GST, q_grandTotal, mtr_id, v_id) values ('{$q_labourCharge}','{$q_shiftingCharge}','{$q_subTotal}','{$GST}','{$grandTotal}','{$mtr_id}','{$v_id}')")
            or die("Error in Query Using Die" . $mysqlicon->error);
    if ($query) {
        echo "<script>alert('Record Inserted');</script>";
    }
}
//Notice: Undefined index: q_subTotal in C:\xampp\htdocs\Akshar_Graphics\ins_quotation.php on line 25
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
          <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="ins_quotation.php">Insert Quotation Details</a>
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input id="form_name" name="q_labourCharge" type="text" class="form-control" placeholder="₹00">
                      </div>
                    </div>
                    <div class="col-md-2 px-1">
                      <div class="form-group">
                        <label>Transportation Charge</label>
                        <input id="form_name" name="q_shiftingCharge" type="text" class="form-control" placeholder="₹00">
                      </div>
                    </div>
                    <div class="col-md-5 px-1">
                        <div class="form-group">
                            <label>Sub total</label>
                            <input id="form_name" name="q_subTotal" type="text" class="form-control" placeholder="₹00">
                        </div>
                    </div>  
                  </div>
                  <div class="row">
