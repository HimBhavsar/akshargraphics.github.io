...
if ($_POST) {
    ...
    $query = $mysqlicon -> query("insert into order_table (o_status, o_paymentType, o_paymentDate, c_id, mtr_id, q_id) values ('{$o_status}','{$o_paymentType}','{$o_paymentDate}','{$c_id}','{$mtr_id}','{$q_id}')")
            or die("Error in Query Using Die" . $mysqlicon->error);
    if ($query) {
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
          <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="ins_order.php">Insert Order Details</a>
                        </div>
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 pr-1 px-1">
                        ...
                        <input id="form_name" name="o_paymentDate" type="date" class="form-control" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
