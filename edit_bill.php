...
$mysqlicon = connection_open();
    ...
    if ($_POST) {
        ...
        $b_date = $_POST['b_date'];
        $q_id = $_POST['q_id'];
        $mtr_id = $_POST['mtr_type'];
        
        $query = $mysqlicon->query("UPDATE `bill_table` SET `b_date`='{$b_date}',`c_id`='{$c_id}',`q_id`='{$q_id}',`mtr_id`='{$mtr_id}' WHERE b_id='{$a}'")
                or die("Error in Query Using Die" . $mysqlicon->error);
        if ($query) {
            // header ('Location:disp_attendance_table.php');
            echo "<script>alert('Record updated');window.location='view_bill.php';</script>";
        }
    }
    $fetch_query = $mysqlicon->query("select * from bill_table where b_id='{$a}'") or die("Error in Query" . $mysqlicon->error);
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
          <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="edit_bill.php">Update Bill Details</a>
                        </div>
          ...
          <div class="col-md-12">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Update Bill Details</h5>
              </div>
              <div class="card-body">
                  <form method="post">
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-3 px-1">
                            <div class="form-group">
                                ...
                                <input id="form_name" value="<?php echo $fetchdata['b_date']; ?>" type="date" name="b_date" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4 px-1">
                            <div class="form-group" style="padding-left: 14px">
