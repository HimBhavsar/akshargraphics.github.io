...
$mysqlicon = connection_open();
    ...
    if ($_POST) {
        ...
        $query = $mysqlicon->query("UPDATE `material_table` SET `mtr_type`='{$mtr_type}',`mtr_pricePerFeet`='{$mtr_pricePerFeet}',`mtr_designCharge`='{$mtr_designCharge}' WHERE mtr_id='{$a}'")
                or die("Error in Query Using Die" . $mysqlicon->error);
        if ($query) {
            // header ('Location:disp_attendance_table.php');
            echo "<script>alert('Record updated');window.location='view_materials.php';</script>";
        }
    }
    $fetch_query = $mysqlicon->query("select * from material_table where mtr_id='{$a}'") or die("Error in Query" . $mysqlicon->error);
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
          <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="edit_material.php">Update Materials Details</a>
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-1 px-1">
                        <div class="form-group" style="padding-left: 12px;">
                            ...
                            <input id="form_name" value="<?php echo $fetchdata['mtr_type']; ?>" type="text" name="mtr_type" class="form-control" placeholder="Material Type">
                        </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input id="form_name" value="<?php echo $fetchdata['mtr_pricePerFeet']; ?>" type="text" name="mtr_pricePerFeet" class="form-control" placeholder="Ex. ₹000">
                      </div>
                    </div>
                    <div class="col-md-5 px-1">
                      <div class="form-group">
                        <label>Design Charge</label>
                        <input id="form_name"  value="<?php echo $fetchdata['mtr_designCharge']; ?>" name="mtr_designCharge" type="text" class="form-control" placeholder="Ex. ₹000">
                      </div>
                    </div>
                  </div>
                  <div class="row">
        ...
        <div class="container-fluid">
          <div class="row">
              ...
              <ul>
                ...
                <li>
                    <a href="./ins_material.php">Insert Materials Details</a>
                </li>
              </ul>
          </nav>
