                ...
                <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="view_client.php">Client Details</a>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['deleteid'])){
                                                ...
                                                $deletequery = $mysqlicon->query("delete from client_table where c_id='{$deleteid}'") or die("Error in Query".$mysqlicon->error);
                                            }
                                        ?>
                                        <table class="table">
                                            ...
                                            <?php
                                                ...
                                                while ($row = $query->fetch_array()) {
                                                    ...
                                                    . "<td>{$row['c_name']}</td>"
                                                    . "<td>{$row['c_mob']}</td>"
                                                    . "<td>{$row['v_feedback']}</td>"
                                                    . "<td>{$row['mtg_type']}</td>"
                                                    . "<td>{$row['mtg_date']}</td>";
                                                    echo "<td><a Onclick='return ConfirmDelete();' href='?deleteid={$row['c_id']}'>Delete</a></td>";
                                                    echo "</tr>";
                                                }                   
                                            ?>
                                        </table>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <nav class="footer-nav">
                                    <ul>
                                        <li>
                                            <a href="./ins_client.php">Insert Client Details</a>
                                        </li>
                                    </ul>
                                </nav>
